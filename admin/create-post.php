        ...
        <div class="col">
          <div class="card">
            <div class="card-body py-4">
              ...
              <!-- Vertical Form -->
              <form action="../_actions/create-post.php" class="row g-3 needs-validation" method="post" enctype="multipart/form-data" novalidate>
                <div class="col-12">
                  <label for="validationCustomUsername" class="form-label">Title</label>
                  <div class="has-validation">
                    <input type="text" name="title" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
                ...
                <div class="col-12">
                  ...
                  <div class="has-validation">
                  <textarea name="content" rows="4" id="validationCustomContent" class="form-control" required></textarea>
                    <div class="invalid-feedback">
                      Enter a content.
                    </div>
                  </div>
                ...
                <div class="col-12">
                  <label for="validationCustomImage" class="form-label">Image</label>
                  <div class="has-validation">
                    <input type="file" name="image" class="form-control" id="validationCustomImage" aria-describedby="inputGroupPrepend" required>
                    <div class="invalid-feedback">
                      Choose a image.
                    </div>
                  </div>
