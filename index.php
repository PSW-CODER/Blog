<?php
    ...
    if($table){
      $totalPost = count($table->getAll()); // Pagination $start = 0;
      $start = 0;
      $rowsPerPage = 6; 
      $pages = ceil($totalPost / $rowsPerPage);
      if(isset($_GET['page-no'])){ 
        $id = $_GET['page-no']; 
        $start = ($_GET['page-no'] - 1) * $rowsPerPage; 
        $results = $table->pagination($start, $rowsPerPage); 
      }else{
        $id = 1; 
        $results = $table->pagination($start, $rowsPerPage); 
      } 
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body id="<?= $id ?>">
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination">
              ...
              <?php
                ...
                ?>
              <li class="page-item">
                <a href="index.php?page-no=<?= $i ?>" class="page-link page-no"
                  ><?= $i ?></a
                >
              </li>
              <?php
    ...
    <script>
      ...
      const pageNoList = document.querySelectorAll(".page-no");
      pageNoList[bodyId - 1].classList.add("active");
    </script>
  </body>
</html>
